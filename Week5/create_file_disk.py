'''Maya Purohit
BigDataX REU 2024
The purpose of this file is to write large files in order to determine the energy used by the machine when writing to disk
...
def writeFile(filename, power10, original_time):
    ...
    full_path = os.path.join("/home/cc/transfer_files", filename)
...
def write(numFiles): 
    ...
    os.makedirs("/home/cc/transfer_files", exist_ok= True)   
...
def run():
    ...
    write(sys.argv[1]) #calls the function to run the program
