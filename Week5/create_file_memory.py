'''Maya Purohit
BigDataX REU 2024
The purpose of this file is to write large files in order to determine the energy used by the machine when written to memory
...
def write(numFiles): 
    ...
    print("Writing files: ", datetime.now())
